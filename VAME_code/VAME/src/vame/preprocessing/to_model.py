...
def format_xarray_for_rnn(
    ...
    read_derivatives_from_variables: list[str] | None = None,
    ...
    read_from_variable : str, default="position_processed"
        The variable to read the position data from the dataset.
    read_derivatives_from_variable : str | None, optional
        The variable to read data derived from the position data from the dataset.
    ...
    # Append derivative variables
    if read_derivatives_from_variables is not None:
        n_derived_features = len(read_derivatives_from_variables)
        for feature_name in read_derivatives_from_variables:
            series = ds[feature_name].values
